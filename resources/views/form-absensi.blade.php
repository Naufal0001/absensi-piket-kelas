                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                    ...
                                    <input type="text" hidden name="id[]" value="{{ $r->SiswaRecapt->id }}" id="">
                                    <td class="px-6 py-4">{{ $r->SiswaRecapt->nis }}</td>
                                    <td class="px-6 py-4">{{ $r->SiswaRecapt->nama }}</td>
                                    <td class="px-6 py-4">{{ $r->SiswaRecapt->jenis_kelamin }}</td>
                                    <td class="px-6 py-4">
                                        {{ $r->keterangan }}
                                    </td>
                                    <td class="px-6 py-4">
